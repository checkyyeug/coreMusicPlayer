...
public:
     ...
     * @param accent 强调色
     */
    void setCustomTheme(const QColor& background, const QColor& foreground, const QColor& accent);
...
private:
    ...
    /// 自定义主题颜色映射
    QMap<QString, QColor> custom_colors_;
     ...
     * @return 颜色值
     */
    QColor getColorForTheme(ThemeType theme, const QString& color_name) const;
};
