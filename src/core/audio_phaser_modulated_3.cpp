...
bool AudioPhaserModulated3::setParameters(float rate, float depth, float feedback, float mix, 
...
void AudioPhaserModulated3::getParameters(float& rate, float& depth, float& feedback, float& mix, 
