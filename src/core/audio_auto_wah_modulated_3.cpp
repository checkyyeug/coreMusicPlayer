...
bool AudioAutoWahModulated3::setParameters(float rate, float depth, float feedback, float mix, 
...
void AudioAutoWahModulated3::getParameters(float& rate, float& depth, float& feedback, float& mix, 
