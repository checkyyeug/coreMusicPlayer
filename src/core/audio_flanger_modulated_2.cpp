...
bool AudioFlangerModulated2::setParameters(float rate, float depth, float feedback, float mix, 
...
void AudioFlangerModulated2::getParameters(float& rate, float& depth, float& feedback, float& mix, 
