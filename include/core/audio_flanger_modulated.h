#ifndef CORE_AUDIO_FLANGER_MODULATED_H
#define CORE_AUDIO_FLANGER_MODULATED_H
...
// 音频调制镶边器类
class AudioFlangerModulated {
public:
    // 构造函数
    AudioFlangerModulated();
...
#endif // CORE_AUDIO_FLANGER_MODULATED_H