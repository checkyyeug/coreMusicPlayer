#ifndef CORE_AUDIO_AUTO_WAH_MODULATED_2_H
#define CORE_AUDIO_AUTO_WAH_MODULATED_2_H
...
// 音频调制AutoWah类（版本2）
class AudioAutoWahModulated2 {
public:
    // 构造函数
    AudioAutoWahModulated2();
...
#endif // CORE_AUDIO_AUTO_WAH_MODULATED_2_H