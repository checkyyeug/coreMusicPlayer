#ifndef CORE_COMPLETE_STRATEGY_H
#define CORE_COMPLETE_STRATEGY_H
...
// Complete播放策略 - 完整功能实现，支持多种格式和高级特性
class CompleteStrategy : public PlayerStrategy {
public:
    // 构造函数
    CompleteStrategy();
...
#endif // CORE_COMPLETE_STRATEGY_H